      ...
      <div className="w-full md:w-[75%] mt-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mt-5">
          <div className="bg-[#88d18a] shadow-md border border-gray-200 rounded-lg">
            <img src={study} className="h-[30vh] w-full" />
            <button className="bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded w-full">
              Study
            </button>
          </div>
          <div className="bg-[#88d18a] shadow-md border border-gray-200 rounded-lg">
            <img src={planner} className="h-[30vh] w-full" />
            <button className="bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded w-full">
              Planner
            </button>
          </div>
          <div className="bg-[#88d18a] shadow-md border border-gray-200 rounded-lg">
            <img src={wishlist} className="h-[30vh] w-full" />
            <button className="bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded w-full">
              Wishlist
            </button>
          </div>
          <div className="bg-[#88d18a] shadow-md border border-gray-200 rounded-lg">
            <img src={schedule} className="h-[30vh] w-full" />
            <button className="bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded w-full">
              Schedule
            </button>
          </div>
          <div className="bg-[#88d18a] shadow-md border border-gray-200 rounded-lg">
            <img src={leisure} className="h-[30vh] w-full" />
            <button className="bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded w-full">
              Leisure
            </button>
          </div>
          <div className="bg-[#88d18a] shadow-md border border-gray-200 rounded-lg">
            <img src={work} className="h-[30vh] w-full" />
            <button className="bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded w-full">
              Work
            </button>
          </div>
